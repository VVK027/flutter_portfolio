...
/// Minimal SVG path `d` parser for single-path brand icons.
    ...
    switch (upper) {
      ...
      case 'C':
        while (index < tokens.length && !_isCommand(tokens[index])) {
          ...
          final x = read();
          final y = read();
          final cx1 = isRelative ? currentX! + x1 : x1;
          final cy1 = isRelative ? currentY! + y1 : y1;
          final cx2 = isRelative ? currentX! + x2 : x2;
          final cy2 = isRelative ? currentY! + y2 : y2;
          currentX = isRelative ? currentX! + x : x;
          currentY = isRelative ? currentY! + y : y;
